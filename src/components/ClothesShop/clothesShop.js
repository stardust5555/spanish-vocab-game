...
import {questions} from "../../libs/clothesShopQuestions"
...
const handleAnswerButtonClick = function (userAnswer){
    ...
    return(
        ...
        <div className="ClothesShop">
			...
			<img class="clothesShopBackground" src={ require('./clothesShop.jpg') } alt="clothes shop background"/>
			<div className="ClothesShopContent">
